...
public class SoftApConfigActivity extends BaseActivity implements View.OnClickListener, YaokanSDKListener {
    ...
    protected void initView() {
        ...
        rgDeviceType.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.cb_1101) {
                    deviceType = Contants.YKK_MODEL_1011;
                } else if (checkedId == R.id.cb_1103) {
                    deviceType = Contants.YKK_MODEL_1013;
                } else if (checkedId == R.id.cb_ds16) {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_smart_config) {
            ...
            case ParamConfigResult:
                if (dialog != null) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            dialog.dismiss();
                            String msg = ykMessage.getMsg();
                            if (msg.contains("配网成功"))
                                DlgUtils.createDefDlg(activity, "","配网成功" , new DialogInterface.OnClickListener() {
                                    @Override
