...
//        list.add(new BedMode(BedMode.MODE_YOGA, "瑜伽模式", MpeDataKey.YOGA.getKey()));
        ...
        adapter = new CommonAdapter<BedMode>(getActivity(), R.layout.item_bed_lv, list) {
            ...
            @Override
            protected void convert(ViewHolder holder, final BedMode bedMode, int position) {
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            } else if (id == R.id.ll_head_down) {
                m = MpeDataKey.HEADDROP.getKey();
            } else if (id == R.id.ll_foot_up) {
                m = MpeDataKey.FEETRISE.getKey();
            } else if (id == R.id.ll_foot_down) {
                m = MpeDataKey.FEETDROP.getKey();
            } else if (id == R.id.ll_haf_up) {
                m = MpeDataKey.BOTHRISE.getKey();
            } else if (id == R.id.ll_haf_down) {
