...
public class SettingActivityYK extends BaseActivity implements View.OnClickListener {
    RelativeLayout delete, rename;
    RemoteCtrl uiRc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_yk);
