...
public class RfMatchActivity extends BaseActivity implements YaokanSDKListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Yaokan.instance().getRfMatchingResult(YaoKanSDK.curMac, YaoKanSDK.curTid, YaoKanSDK.curBid);
        findViewById(R.id.btn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rc.getId() == 0) {
                    ...
                    //射频按键没有学习直接创建时，调用此接口
                    showDlg();
                    rc = Yaokan.instance().uploadRfAndSave(YaoKanSDK.curMac, rc);

                } else {
                    showDlg();
                    Yaokan.instance().downloadRFCodeToDevice(YaoKanSDK.curDid, rc.getRid(), rc.getBe_rc_type());
                }
            }
        });
    }
    ...
    private void initNormal() {
        rc.setName(YaoKanSDK.curBName + YaoKanSDK.curTName);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!isStudy) {
                    Yaokan.instance().sendCmd(YaoKanSDK.curDid, rc.getRid(), rc.getRcCmd().get(position).getValue(), rc.getBe_rc_type(), rc.getStudyId(), rc.getRf());
                }
            }
        });
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Yaokan.instance().studyRf(  YaoKanSDK.curDid, rc, rc.getRcCmd().get(position).getValue());
                showDlg("请对准小苹果发码...", new DialogInterface.OnCancelListener() {
                    ...
                    public void onCancel(DialogInterface dialog) {
                        ...
                        Yaokan.instance().stopStudyRf(  YaoKanSDK.curDid, rc);
                    }
                });
                newCountDownTime();
                isStudy = true;
...
//                        log(ykMessage.toString());
                    ...
                    case RfUploadSuccess:
                        Yaokan.instance().downloadRFCodeToDevice(YaoKanSDK.curDid, rc.getStudyId(), rc.getBe_rc_type());
                        break;
                    case RfUploadFail:
                        dismiss();
