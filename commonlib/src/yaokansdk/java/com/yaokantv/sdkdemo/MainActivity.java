    ...
    private void initView() {
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                } else if (itemId == R.id.export_error_log) {
...
//                        Yaokan.instance().test(item.getDid());
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_hot_point_config) {
            Yaokan.instance().hotPointConfig();
        } else if (id == R.id.btn_soft_ap_config) {
        ...
        } else if (id == R.id.btn_input_device_list) {//导入设备方式一
//                if (mList.size() > 0) {
...
//                }
        ...
        } else if (id == R.id.btn_device_list) {//导出设备方式一
