...
public class AppleCtrlListActivity extends BaseActivity implements YaokanSDKListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Yaokan.instance().deviceCtrlList(YaoKanSDK.curDid, "01", 15);
        findViewById(R.id.btn_load).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDlg();
                Yaokan.instance().deviceCtrlList(YaoKanSDK.curDid, "15", 15);
            }
        });
        findViewById(R.id.btn_delete_all).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Yaokan.instance().deleteAllDevice(YaoKanSDK.curDid);
            }
        });
    }
                        ...
                        DlgUtils.createDefDlg(AppleCtrlListActivity.this, "", "是否删除改遥控器？",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Yaokan.instance().deleteDeviceCode(YaoKanSDK.curDid, item.getRid());
