...
public class SmartInfoVo implements Parcelable {
    ...
    public FamilysBean getFamily() {
        return family;
    }

    public void setFamily(FamilysBean family) {
        this.family = family;
    }
    ...
    protected SmartInfoVo(Parcel in) {
    ...
    public FamilysBean getFamilys() {
        return family;
    }

    public void setFamilys(FamilysBean familys) {
        this.family = familys;
    }
    ...
    public static class FamilysBean implements Parcelable {
        ...
        private List<OtherDevices> otherDevices;
        ...
        public void setOtherDevices(List<OtherDevices> otherDevices) {
        ...
        public class OtherDevices{
            ...
            public String getOwnFamily() {
                return ownFamily;
            }

            public void setOwnFamily(String ownFamily) {
        ...
        public static class DeviceInfoBean implements Parcelable {
            ...
            public static class FieldBean implements Parcelable {
                ...
                private String switchChildLock;
                ...
                public String getSwitchChildLock() {
                    return switchChildLock;
                }

                public void setSwitchChildLock(String switchChildLock) {
                    this.switchChildLock = switchChildLock;
                }
                ...
                public void writeToParcel(Parcel dest, int flags) {
                    ...
                    dest.writeString(this.switchChildLock);
                    dest.writeString(this.operate1);
                    dest.writeString(this.operate2);
                ...
                protected FieldBean(Parcel in) {
                    ...
                    this.switchChildLock=in.readString();
                    this.operate1=in.readString();
                    this.operate2=in.readString();
                }
                ...
                public String toString() {
                    return "FieldBean{" +
                            ...
                            ", mode='" + mode + '\'' +
                            ", state='" + state + '\'' +
                            ", switchChildLock='" + switchChildLock + '\'' +
                            ", operate1='" + operate1 + '\'' +
                            ", operate2='" + operate2 + '\'' +
                            '}';
                }
        ...
        public static class GatewaysBean implements Parcelable {
            ...
            public void writeToParcel(Parcel dest, int flags) {
                ...
                dest.writeByte(gatewayOnline ? (byte) 1 : (byte) 0);
            }
