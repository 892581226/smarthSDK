 ...
 * version:
 */
public class GatewayNetSettingActivity extends BaseActivity implements View.OnClickListener, BaseDialog.OnConfirmListener, BaseDialog.OnCancelListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addDestoryActivity(this,"GatewayNetSettingActivity");
        initView();
        initDate();
