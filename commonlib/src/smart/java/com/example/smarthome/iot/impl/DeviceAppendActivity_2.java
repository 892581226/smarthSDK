 ...
 * version:
 */
public class DeviceAppendActivity_2 extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
...
//            SPUtils.put(DeviceAppendActivity_2.this,"scan_gateway",deviceInfoBean.getId());
        }
        initView();
        initDate();
    }
...
//                            bundle.putString(DeviceAppendFragment.ID,deviceInfoBean.getId());
                    ...
                    public void onError(@io.reactivex.annotations.NonNull Throwable e) {
                        e.printStackTrace();
                        Toast.makeText(DeviceAppendActivity_2.this, "请求失败", Toast.LENGTH_LONG).show();
                        loadingDialog.dismiss();
                    }
