 ...
 * version:
 */
public class SceneSwitchStatusAdapter extends BaseQuickAdapter<SwitchStatusBeanVo, BaseViewHolder> {

    public SceneSwitchStatusAdapter(List<SwitchStatusBeanVo> data) {
