...
public class ProgressView extends View {
    ...
    public ProgressView(Context context,int defaultColor) {
        this(context, null,defaultColor);
    }

    public ProgressView(Context context, AttributeSet attrs,int defaultColor) {
        this(context, attrs, -1,defaultColor);
    }

    public ProgressView(Context context, AttributeSet attrs, int defStyleAttr,int defaultColor) {
