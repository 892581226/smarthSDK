 ...
 * version:
 */
public class RoomDevicePagerFragment extends Fragment implements BaseQuickAdapter.OnItemChildClickListener, View.OnClickListener {
...
//    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            LogUtils.e("mDeviceManageItemVos  onCreate",mDeviceManageItemVos.size()+"-----------");
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        if (view.getId() == R.id.item_iot_device_linear) {
            ...
            // 鸿雁开关控制
            else if (deviceType.equalsIgnoreCase(DeviceType.HONGYAN_SWITCH_1)){
                intent.setClass(getActivity(),SingleBitSwitchActivity.class);
            }else if (deviceType.equalsIgnoreCase(DeviceType.HONGYAN_SWITCH_2)){
                intent.setClass(getActivity(),DoubleBitSwitchActivity.class);
            }else if (deviceType.equalsIgnoreCase(DeviceType.HONGYAN_SWITCH_3)){
                intent.setClass(getActivity(),ThreeBitSwitchActivity.class);
            }else if (deviceType.equalsIgnoreCase(DeviceType.HONGYAN_SWITCH_4)){
                intent.setClass(getActivity(),FourBitSwitchActivity.class);
            }
            ...
            else if (deviceType.equalsIgnoreCase(DeviceType.HONGYAN_DOOR_MAGNETIC)) {
                //鸿雁门磁传感器
                intent.setClass(getActivity(), DoorMagnetActivity.class);
            }
            else if (deviceType.equalsIgnoreCase(DeviceType.HONGYAN_HUMAN_INFRARED)) {
                //鸿雁人体红外传感器
                intent.setClass(getActivity(), HumanSensorActivity.class);
            }
                ...
                //双规窗帘开关
                intent.setClass(getActivity(), DoubleCurtainSwitchActivity.class);
            }
