...
import com.example.smarthome.iot.GatewayNetSettingActivity;
 ...
 * version:
 */
public class DeviceConnectStepActivity_gateway extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = SPUtils.get(DeviceConnectStepActivity_gateway.this, SpConstant.SP_USER_TELEPHONE, "");
    ...
    private void initDate() {
        getJurisdiction = SPUtils.get(DeviceConnectStepActivity_gateway.this, "getJurisdiction" + userId, 0);
        //萤石摄像头暂时注释
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.top_back) {
            ...
            if (devListBean.getDeviceType().equalsIgnoreCase(DeviceType.HILINK_GATEWAY)) {
                Intent intent = new Intent(DeviceConnectStepActivity_gateway.this, GatewayNetSettingActivity.class);
                ...
                if (getJurisdiction == 0) {
                    ToastUtil.show(DeviceConnectStepActivity_gateway.this, "非自己家庭无法增加摄像头");
                    return;
                }
                if (Build.VERSION.SDK_INT >= 23 && ContextCompat.checkSelfPermission(DeviceConnectStepActivity_gateway.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    String[] mPermissionList = new String[]{
                            Manifest.permission.CAMERA};
                    ActivityCompat.requestPermissions(this, mPermissionList, 123);
                } else {
                    mIntent.setClass(DeviceConnectStepActivity_gateway.this, YsCaptureActivity.class);//萤石测试
                    startActivity(mIntent);
                }
            } else {
                Intent intent = new Intent(DeviceConnectStepActivity_gateway.this, ScanAddDeviceActivity.class);
                intent.putExtra("DeviceBean", devListBean);
                intent.putExtra("supplierId", supplierId);
                startActivity(intent);
            }
...
//                        addDisposable(d);
                    ...
                    public void onError(@NonNull Throwable e) {
                        e.printStackTrace();
                        Toast.makeText(DeviceConnectStepActivity_gateway.this, "请求失败", Toast.LENGTH_LONG).show();
                    }
    ...
    public void onRequestPermissionsResult(int requestCode, @android.support.annotation.NonNull String[] permissions, @android.support.annotation.NonNull int[] grantResults) {
        if (requestCode == 123) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission Denied
                ToastUtil.show(DeviceConnectStepActivity_gateway.this, "无摄像头权限");
//                return;
            }
        }
    }
