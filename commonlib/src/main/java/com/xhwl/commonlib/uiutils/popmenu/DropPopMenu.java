package com.xhwl.commonlib.uiutils.popmenu;
...
//    private List<Family> mMenuItemList;
    /**
     * 指示器与菜单布局两侧的最小间距
     */
...
//    public void setMenuList(List<Family> menuList) {
//        if (mMenuItemList != null) {
//            mMenuItemList.clear();
//        } else {
...
//            String itemTitle = mMenuItemList.get(i).getFamilyName();
...
//        void onItemClick(AdapterView<?> adapterView, View view, int position, long id, Family menuItem);
//    }
