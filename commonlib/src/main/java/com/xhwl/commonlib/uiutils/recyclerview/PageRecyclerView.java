...
public class PageRecyclerView extends RecyclerView {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        shortestDistance = getMeasuredWidth() / 15 ;
    }
    ...
    public class PageAdapter extends Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (position < dataList.size()) {
                ...
                mCallBack.onBindViewHolder(holder, position, isShow);
//                mCallBack.onItemClickListener(holder.itemView, position);
//                mCallBack.onItemLongClickListener(holder.itemView, position);
            } else {
        ...
        private void setListener(ViewHolder holder) {
            // 设置监听
            holder.itemView.setOnClickListener(v -> mCallBack.onItemClickListener(holder, v, (Integer) v.getTag()));
    ...
    public interface CallBack {
         ...
         * @param position
         */
        void onBindViewHolder(ViewHolder holder, int position, boolean isShow);
