...
public class DropPopLayoutIot extends LinearLayout {
    ...
    public DropPopLayoutIot(Context context, boolean isLeft) {
        super(context);
        initView(isLeft);
    }

    public DropPopLayoutIot(Context context, AttributeSet attrs, boolean isLeft) {
        super(context, attrs);
        initView(isLeft);
    }
    ...
    private void initView(boolean isLeft) {
        ...
        mTriangleUpIndicatorView.setLayoutParams( new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
