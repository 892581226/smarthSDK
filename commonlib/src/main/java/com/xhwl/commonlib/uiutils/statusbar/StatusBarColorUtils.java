package com.xhwl.commonlib.uiutils.statusbar;
...
/**
 * Created by glq on 18-12-24.
 *
 * 适配meizu oppo xiaomi 反色状态栏
 */
public class StatusBarColorUtils {
    ...
    //OPPO适配状态栏颜色
    private int SYSTEM_UI_FLAG_OP_STATUS_BAR_TINT = 0x00000010;
     ...
     * Oppo状态栏字体反色适配
     */
    public void setLightStatusBarIconOppo(Activity context, boolean lightMode) {
     ...
     * Oppo状态栏字体反色适配
     */
    public void setLightStatusBarIconXiaomi(Activity context, boolean lightMode) {
        Window window = context.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
