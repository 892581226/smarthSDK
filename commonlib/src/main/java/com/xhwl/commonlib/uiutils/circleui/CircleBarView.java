...
public class CircleBarView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        bgColor = typedArray.getColor(R.styleable.CircleBarView_progress_color,Color.GRAY);
        ...
        barWidth = typedArray.getDimension(R.styleable.CircleBarView_bar_width, UiTools.dip2px(context,10));
        typedArray.recycle();

        progressNum = 0;
        maxNum = 100;
        defaultSize = UiTools.dip2px(context,100);
        mRectF = new RectF();
